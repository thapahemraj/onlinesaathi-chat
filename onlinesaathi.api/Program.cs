...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "OnlineSaathi API", Version = "v1" });
...
.AddJwtBearer(x =>
{
    ...
    // Configure SignalR to use the token for WebSocket connections
